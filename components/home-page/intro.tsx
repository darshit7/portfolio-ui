  ...
  return (
    <>
      ...
      <p className="mt-5 text-neutral-900 dark:text-neutral-200">
        ...
        <Twemoji emoji="robot" /> can be translated into reliable, production grade platforms -
      ...
      <p className="mt-5 text-neutral-900 dark:text-neutral-200">
        ...
        reading <Twemoji emoji="open-book" /> or following my favorite sports like cricket{' '}
