export const BLOG_METADATA = [
    ...
    {
        "id": 3,
        "title": "Exploring the Magic of Generators in Python: A Beginner’s Guide with Six Real-Life Examples",
    ...
    {
        "id": 2,
        "title": "Deep Dive into The Fascinating Journey of ChatGPT’s Training Process: Unveiling the Magic of Language Generation",
