  ...
  return (
    <html lang={siteMetadata.language} className="scroll-smooth">
      <head>
          ...
          <link rel="icon" type="image/png" sizes="32x32" href="/static/favicons/favicon_32.png" />
          <link rel="icon" type="image/png" sizes="16x16" href="/static/favicons/favicon_16.png" />
